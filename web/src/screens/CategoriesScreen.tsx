...
/* Те же двенадцать тонов, что и в токенах `--cat-*`, и выбор ограничен
   ими намеренно. Этими цветами раскрашивается кольцо расходов: произвольный
   цвет рядом с ними превратил бы график в радугу, а закрытая палитра
   держит его согласованным при любом наборе категорий. */
const PALETTE = [
  '#e0446b', '#ef6b45', '#e0940e', '#86a828', '#23a06a', '#12a2a0',
  '#2b93d8', '#4d6fd4', '#8259d0', '#b34fb0', '#a9714f', '#6f7a90',
];
