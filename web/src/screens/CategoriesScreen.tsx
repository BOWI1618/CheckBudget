...
/* Те же двенадцать тонов, что и в токенах `--cat-*`. Выбор ограничен ими
   намеренно: этот цвет становится заливкой крупной плитки на сводке, и он
   обязан держать светлый текст поверх себя. Произвольный цвет сделал бы
   плитку нечитаемой ровно в том месте, где она заметнее всего. */
const PALETTE = [
  '#6b3f52', '#487853', '#8f6415', '#8d5a35', '#34698f', '#3d52a0',
  '#a8451c', '#2f6b3f', '#c0392b', '#2d6b68', '#5f6b2a', '#7a6a5c',
];
